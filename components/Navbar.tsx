        ...
        <ul className='w-full mt-4 lg:hidden absolute z-10 top-6'>
          {isMenuExpanded && (
            NavbarLinks.map((link, index) => (
              <li key={index} className='first:rounded-t-[20px] last:rounded-b-[20px] h-10 bg-black-2 py-2 mb-1.5 last:mb-0 text-center'>
                <a
                  href={link.route}
                  className=' text-grey text-base font-montserrat cursor-pointer px-4'>
